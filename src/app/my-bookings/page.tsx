...
export default function MyBookings() {
  ...
  useEffect(() => {
    const getData = async()=>{
      try {
        const data = await axios.post(User_Api_Routes.GET_USER_BOOKINGS,{userId: userInfo?.id})
  ...
  }, [filterValue, onSearchChange, statusFilter, bookings.length, onRowsPerPageChange, onClear]);
