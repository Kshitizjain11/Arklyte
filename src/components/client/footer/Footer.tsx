...
const Footer = () => {
  ...
  return (
    <footer
      className="min-h-[20vh] px-48 py-10 relative bg-cover bg-center bg-no-repeat bg-[url(/home/home-bg.png)]"
      ...
      <div className="relative z-10 p-4 grid grid-cols-4 gap-20 text-white">
        ...
        <div className="flex flex-col gap-3 pt-10">
          ...
          <ul className="flex  gap-5 mt-5">
            <li className="bg-purple-500/30 rounded-lg text-purple-500 text-3xl p-3 cursor-pointer hover:bg-opacity-50 transition-all duration-300">
              <FaFacebook />
            </li>
            <li className="bg-purple-500/30 rounded-lg text-purple-500 text-3xl p-3 cursor-pointer hover:bg-opacity-50 transition-all duration-300">
              <FaInstagram />
