                    ...
                    if (!alreadyScraped) {
                        ...
                        if (pkg.id && pkg.name) {
                            const tripData = {
                                ...
                                nights: pkg.nights || 0,
                                days: pkg.days || 0,
                                destinationItinerary: Array.isArray(pkg.destinationItinary) ? pkg.destinationItinary : [],
                                ...
                                detailedItinerary: Array.isArray(pkg.detailedItinary) ? pkg.detailedItinary : [],
